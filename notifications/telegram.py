...
def _handle_start(chat_id: str) -> User:
    ...
    logger.info(
        ...
        extra={"telegram_chat_id": chat_id, "user_id": user.id, "user_created": created},
    )
    _reply(
        chat_id,
